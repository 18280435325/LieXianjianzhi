...
return [
     ...
     */
    'app_id'  => env('WECHAT_APPID', 'wx5642ba0a4ffd98bd'),         // AppID
    'secret'  => env('WECHAT_SECRET', 'af49617df8dd2fc09934c3f92da44278'),     // AppSecret
    'token'   => env('WECHAT_TOKEN', 'zyytest'),          // Token
    ...
    'payment' => [
        ...
        'cert_path'          => env('WECHAT_PAYMENT_CERT_PATH', 'path/to/your/wechatcert.pem'), // XXX: 绝对路径！！！！
